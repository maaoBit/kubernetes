...
func (rw *rwSeparatedRoundBalanced) Pick(opts balancer.PickInfo) (r balancer.PickResult, err error) {
...
func (rw *rwSeparatedRoundBalanced) selectPickFunc(opts balancer.PickInfo) pickerFunc {
